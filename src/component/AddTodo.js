...
class AddTodo extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.state.content.trim()) {
     //reating a json object that will be used as a body request to be sent 
     //to the `addItem` function located in our Express application.
      const jsonObject = {
        id: this.state.id,
     ...
     //making a **POST** request the `addItem` function 
     //located in our Express Application and returning a response message.
     Axios({
      method: "POST",
